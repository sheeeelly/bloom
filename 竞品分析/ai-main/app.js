    ...
    <div class="page">
      <section class="two-col">
        ...
        <article class="card">
          <div class="section-title">
            <div>
              <h3>发起前提醒</h3>
              <p>这部分保持飞书式信息卡风格，帮助业务确认关键边界。</p>
            </div>
          </div>
          <div class="record-list">
            <div class="record-row">
              <strong>输入来源</strong>
              <span class="muted">中山产品研发提供标准素材包，运营负责录入并触发 AI。</span>
            </div>
            <div class="record-row">
              <strong>人工确认字段</strong>
              <span class="muted">Goods ID、DDID、Base Price、US Price 仍由人工确认，不直接交给 AI。</span>
            </div>
            <div class="record-row">
              <strong>生成后流向</strong>
              <span class="muted">保存后进入 AI 生成中，完成后自动进入待上海运营审核。</span>
            </div>
          </div>
        </article>
      </section>
      ...
      <section class="card">
        <div class="section-title">
          <div>
            <h3>素材上传</h3>
            <p>按标准素材包拆分上传，保持每一类素材的状态清晰可见。</p>
          </div>
          <button class="ghost-btn">下载模板说明</button>
        </div>
        <div class="upload-list">
          ${[
            ["全套纸样", "pattern-full.zip", "已上传 · 12.6MB"],
            ["激光纸样", "laser-pattern.pdf", "已上传 · 3.2MB"],
            ["尺码表", "size-chart.xlsx", "已上传 · 892KB"],
            ["图片素材", "image-pack-06.zip", "上传中 · 84%"],
            ["工艺备注", "craft-note.docx", "待上传"],
          ]
            .map(
              ([title, file, note]) => `
                <div class="upload-row">
                  ...
                  <div class="upload-actions">
                    <button class="secondary-btn">替换</button>
